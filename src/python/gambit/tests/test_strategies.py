...
class TestGambitStrategies(object):
    ...
    def test_game_strategies_index_by_strategy(self):
        "Test find a strategy by providing an int"
        self.game.players[0].strategies[0].label = "Cooperate"
        s1 = self.game.players[0].strategies[self.game.players[0].strategies[0]]
        assert s1.label == "Cooperate"
